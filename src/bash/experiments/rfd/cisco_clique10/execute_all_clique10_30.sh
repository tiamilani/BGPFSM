...
for name in ${names[*]}; do
	for i in {1..25}; do
		...
		#python3 analyzer.py -f results/rfd_tests/cisco/cisco_clique10_${name}/cisco_clique10_${name}_${i}/output_0.csv -n 9 -o ${dir_path}mrai${i}_${name}/mrai${i}_${name} -s -F --rfd -r
		#python3 analyzer.py -f results/rfd_tests/cisco/cisco_clique10_${name}/cisco_clique10_${name}_${i}/output_0.csv -n 3 -o ${dir_path}mrai${i}_${name}/mrai${i}_${name} -s -F --rfd -r
		#python3 analyzer.py -f results/rfd_tests/cisco/cisco_clique10_${name}/cisco_clique10_${name}_${i}/output_0.csv -n 7 -o ${dir_path}mrai${i}_${name}/mrai${i}_${name} -s -F --rfd -r
		#python3 analyzer.py -f results/rfd_tests/cisco/cisco_clique10_${name}/cisco_clique10_${name}_${i}/output_0.csv -n 1 -o ${dir_path}mrai${i}_${name}/mrai${i}_${name} -s -F --rfd -r
	done
done
